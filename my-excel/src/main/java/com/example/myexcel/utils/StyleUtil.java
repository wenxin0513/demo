...
public final class StyleUtil {
    ...
    public static Map<String, String> parseStyle(String style) {
        ...
        Map<String, String> result = Maps.newHashMapWithExpectedSize(styleArr.length);
    ...
    public static Map<String, String> mixStyle(Map<String, String> originStyle, Map<String, String> targetStyle) {
        ...
        if (targetStyle == null) {
            return Maps.newHashMap(originStyle);
        } else if (originStyle == null) {
            return Maps.newHashMap(targetStyle);
        }
        // 相加的两倍，防止扩容。
        Map<String, String> result = Maps.newHashMapWithExpectedSize((targetStyle.size() + originStyle.size()) * 2);
